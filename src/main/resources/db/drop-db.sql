...
UPDATE pg_catalog.pg_database SET datallowconn=false WHERE datname='timezone';
--SELECT pg_catalog.pg_terminate_backend(procpid) FROM pg_catalog.pg_stat_activity WHERE datname='timezone';
